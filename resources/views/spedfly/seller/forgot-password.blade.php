    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-5 col-sm-6 col-12">
                <form action="{{ route('seller.password.email') }}" method="post" class="my-5" style="background: #fff; border: 5px solid #f5cf00;">
                    @csrf
                    <div class="rounded-2 p-4">
                        <div class="login-form">
                            ...
                            <center>
                                <h5 class="fw-bold mb-2">{{ __('ui.forgot_password') }}</h5>
                                <p class="mb-4 text-muted">{{ __('ui.enter_your_seller_email_to_receive_a_reset_link') }}</p>
                            </center>
                            ...
                            <div class="d-grid py-3 mt-4">
                                <button type="submit" class="btn btn-lg btn-primary">{{ __('ui.send_reset_link') }}</button>
                            </div>
