...
<div class="app-body">
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('seller.call-center') }}" class="btn btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2 flex-wrap">
                                            <a href="{{ route('seller.order-details', $lead) }}" class="btn btn-outline-primary btn-sm">View</a>
                                          <!--  <form method="POST" action="{{ route('seller.leads.confirm', $lead) }}">
                                                @csrf
                                                @method('PATCH')
                                                <button type="submit" class="btn btn-success btn-sm">Confirm Lead</button>
                                            </form>   -->
                                        </div>
                                    </td>
                                </tr>
