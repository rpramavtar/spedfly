...
@php
    $name = old('name', $user?->name ?? 'Seller');
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
            <div>
                ...
                <small class="text-muted">{{ __('ui.your_seller_account_details_and_edit_profile_settings') }}</small>
            </div>
            ...
            <div class="col-lg-4">
                <div class="card p-4">
                    <div class="text-center">
                        @if ($avatarUrl)
                            <img src="{{ $avatarUrl }}" alt="{{ $name }}" class="profile-avatar-image mx-auto mb-3" style="width: 96px; height: 96px; border-radius: 50%;">
                        @else
                    ...
                    <div class="card p-4 mb-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control bg-light" value="{{ $user?->type ?? 'seller' }}" readonly>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="password" name="current_password" class="form-control" placeholder="{{ __('ui.required_only_for_password_change') }}">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label text-muted">{{ __('ui.new_password') }}</label>
                                <input type="password" name="password" class="form-control" placeholder="{{ __('ui.leave_blank_to_keep_current') }}">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label text-muted">{{ __('ui.confirm_password') }}</label>
                                <input type="password" name="password_confirmation" class="form-control" placeholder="{{ __('ui.repeat_new_password') }}">
                            </div>
                            <div class="col-12">
